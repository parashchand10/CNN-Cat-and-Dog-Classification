...
# Loading the .keras model directly needs TensorFlow itself as the backend
# (Keras 3's load_model() delegates the actual graph execution to it).
import tensorflow as tf

app = Flask(__name__)

BASE_DIR = os.path.dirname(os.path.abspath(__file__))
MODEL_PATH = os.path.join(BASE_DIR, "model", "cat_dog_cnn_model_v2.keras")
